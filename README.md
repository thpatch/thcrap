...
* Install [Visual Studio Community 2017](https://visualstudio.microsoft.com/vs/older-downloads/).
  * You can also use [Visual Studio Community 2019](https://visualstudio.microsoft.com/vs/). During installation, make sure to install the v141 and v141_xp toolsets (v141_xp is the Visual Studio 2017 compiler with Windows XP compatibilité, and v141 is required by v141_xp).
