...
typedef struct {
	...
	// Additional sprites generated by anm_entry_init() to deal with wraparounds.
	// Pointers to these are copied to [sprites].
	sprite_t *sprites_wrap;
	size_t sprite_wrap_num;
} anm_entry_t;
