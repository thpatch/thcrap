...
DECLARE_WRAPPER(BOOL, loader_update_with_UI, const char *exe_fn, char *args);

DECLARE_WRAPPER(int, RepoDiscoverAtURL, const char *start_url, json_t *id_cache, json_t *url_cache);
